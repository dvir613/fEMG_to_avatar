...
REM Run the EMG_to_Avatar_model.py script with EnhancedTransformNet
...
REM Run the EMG_to_Avatar_model.py script with LinearTransformNet
python EMG_to_Avatar_model.py ^
  --data_path "C:/Users/YH006_new/fEMG_to_avatar/data" ^
  --ica_flag ^
  --save_results ^
...
REM Run the EMG_to_Avatar_model.py script with ImprovedEnhancedTransformNet
python EMG_to_Avatar_model.py ^
  --data_path "C:/Users/YH006_new/fEMG_to_avatar/data" ^
  --ica_flag ^
  --save_results ^
