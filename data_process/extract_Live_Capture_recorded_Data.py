...
folder_name = 'Hila_new'  # the name of the folder of the participant's data
participant_number = '05'  # the number of the participant (next times it should be identical to the folder name
scene = '008'  # the scene number of the recording
session = '2'  # the session of the recording
assets_path = fr"C:\Users\Hila\OneDrive\מסמכים\fEMG_to_avatar\liveCapture\Assets"
# Get the absolute path of the current script
script_dir = os.path.dirname(os.path.abspath(__file__))

recordings_files_path = os.path.abspath(os.path.join(script_dir, '..', 'liveCapture', 'Assets'))
anim_file_path = fr"{assets_path}\Rawan\SampleHead [Rawan] [003].anim"
asset_file_path = fr"{assets_path}\[001] Hila_new [008].asset"
