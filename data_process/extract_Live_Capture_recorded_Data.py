...
folder_name = 'Rawan'  # the name of the folder of the participant's data
participant_number = '04'  # the number of the participant (next times it should be identical to the folder name
scene = '003'  # the scene number of the recording
...
asset_file_path = fr"{assets_path}\[001] Rawan [003].asset"
